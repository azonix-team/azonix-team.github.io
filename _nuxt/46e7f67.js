(window.webpackJsonp = window.webpackJsonp || []).push([[14], {
        ...
        var _ = function(e) {
          ...
          , m = function() {
            ...
            function e(t, n) {
                ...
                this.limitN = null,
                this.skipN = null,
                text || this.postprocess.unshift((function(data) {
            ...
            return h(e, [{
                key: "only",
                value: function(e) {
                    return this.onlyKeys = Array.isArray(e) ? e : [e],
                    this
                }
            }, {
                key: "without",
                value: function(e) {
                    return this.withoutKeys = Array.isArray(e) ? e : [e],
                    this
                }
            }, {
                key: "sortBy",
                value: function(e, t) {
                    return this.sortKeys.push([e, "desc" === t]),
                    this
                }
            }, {
                key: "where",
                value: function(e) {
                    return this.query = this.query.find(e),
                    this
                }
            }, {
                key: "search",
                ...
                value: function(e) {
                    ...
                    this.withoutKeys && (this.withoutKeys = this.withoutKeys.filter((function(e) {
                        return e !== h
                    }
                    )));
                    return this.postprocess.push((function(data) {
                        ...
                        if (-1 === t)
                            return n;
                        for (var o = data.slice(t - r, t), c = data.slice(t + 1, t + 1 + l), d = 0, i = r - 1; i >= 0; i--)
                            n[i] = o[d] || null,
                            d++;
                ...
                value: (t = r(regeneratorRuntime.mark((function e() {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                this.sortKeys && this.sortKeys.length && (this.query = this.query.compoundsort(this.sortKeys)),
                                this.skipN && (this.query = this.query.offset(this.skipN)),
                                this.limitN && (this.query = this.query.limit(this.limitN)),
                                data = this.query.data({
                                    removeMeta: !0
                                }),
                                this.onlyKeys && (this.options.watch && this.onlyKeys.push("path", "extension"),
                                t = function(data) {
                                    return data.map((function(e) {
                                ...
                                this.withoutKeys && (this.options.watch && (this.withoutKeys = this.withoutKeys.filter((function(e) {
    ...
    376: function(e, t, n) {
        ...
        var r = n(26)
          ...
          , l = n(38);
        e.exports = function(e) {
            for (var t = r(this), n = l(t), h = arguments.length, c = o(h > 1 ? arguments[1] : void 0, n), d = h > 2 ? arguments[2] : void 0, f = void 0 === d ? n : o(d, n); f > c; )
                t[c++] = e;
            return t
        }
    },
        ...
        r = function() {
            ...
            , function(e, t, n) {
                ...
                function r(e, t) {
                    ...
                    let n = Number(e)
                      , r = Number(t);
                    return n == n || r == r ? n === r : (n = e.toString(),
                    r = t.toString(),
                    n == r)
                }
                function o(e, t, n) {
                    ...
                    let r = Number(e)
                      , o = Number(t);
                    return r == r && o == o ? r < o || !(r > o) && n : r == r && o != o || (o != o || r == r) && (e < t || !(e > t) && (e == t ? n : (r = e.toString(),
                    o = t.toString(),
                    r < o || r == o && n)))
                }
                function l(e, t, n) {
                ...
                class c {
                    ...
                    $type(a, b) {
                        let e = typeof a;
                        return "object" === e && (Array.isArray(a) ? e = "array" : a instanceof Date && (e = "date")),
            ...
            , function(e, t, n) {
                ...
                class o {
                    ...
                    set(e, t) {
                        if (null != t) {
                            if (t in this._lokiMap)
                                throw new Error("Duplicate key for property " + this._field + ": " + t);
                    ...
                    remove(e) {
                        ...
                        delete this._lokiMap[t],
                        delete this._valMap[e]
                    }
                    clear() {
                        this._lokiMap = {},
                        this._valMap = {}
                ...
                function l(e, t, n) {
                    return e instanceof Array ? (e.push(n),
                    e[e.length - 1]) : e instanceof Object ? (e[t] = n,
                    e[t]) : void 0
                }
                function h(e, t) {
                    for (let n in e) {
                ...
                function c(e) {
                    if (/number|string|boolean/.test(typeof e))
                        return e;
                ...
                function w(e, t, n=0) {
                    ...
                    for (const r in e)
                        if ("string" == typeof e[r] && 0 === e[r].indexOf("[%lktxp]")) {
                            ...
                            "object" == typeof e[r] && (e[r] = w(e[r], t, n));
                    return e
                }
                const m = {
                    $eq: !0,
                ...
                class v {
                    ...
                    reset() {
                        return this._filteredRows.length > 0 && (this._filteredRows = []),
                        this._filterInitialized = !1,
                        this
                    }
                    toJSON() {
                        const e = this.copy();
                        return e._collection = null,
                        e
                    }
                    limit(e) {
                        return this._filterInitialized || 0 !== this._filteredRows.length || (this._filteredRows = this._collection._prepareFullDocIndex()),
                    ...
                    sort(e) {
                        ...
                        return this._filteredRows.sort(( (a, b) => e(data[a], data[b]))),
                        this
                    }
                    simplesort(e, t={
                        desc: !1
                        ...
                        !this._filterInitialized && this._collection._rangedIndexes.hasOwnProperty(e)) {
                            let n = this._collection._rangedIndexes[e].index.rangeRequest()
                              , r = [];
                            for (let e of n)
                                r.push(this._collection.get(e, !0)[1]);
                            return this._filteredRows = t.desc ? r.reverse() : r,
                            this._filterInitialized = !0,
                            this
                        }
                        this._filterInitialized || 0 !== this._filteredRows.length || (this._filteredRows = this._collection._prepareFullDocIndex());
                        ...
                        return this._filteredRows.sort(( (a, b) => n(data[a][e], data[b][e]))),
                    ...
                    compoundsort(e) {
                        ...
                        this._filterInitialized || 0 !== this._filteredRows.length || (this._filteredRows = this._collection._prepareFullDocIndex());
                        const data = this._collection._data;
                        return this._filteredRows.sort(( (a, b) => this._compoundeval(e, data[a], data[b]))),
                        this
                    }
                    _compoundeval(e, t, n) {
                    ...
                    sortByScoring(e=!1) {
                        ...
                        return e ? this._filteredRows.sort(( (a, b) => this._scoring[a].score - this._scoring[b].score)) : this._filteredRows.sort(( (a, b) => this._scoring[b].score - this._scoring[a].score)),
                        this
                    }
                    getScoring() {
                        if (null === this._scoring)
                    ...
                    find(e, t=!1) {
                        ...
                        if (!r || "getAll" === n)
                            return t && (this._filteredRows = this._collection._data.length > 0 ? [0] : [],
                            this._filterInitialized = !0),
                            this;
                        if ("$and" === r || "$or" === r)
                            return this[r](o),
                            t && this._filteredRows.length > 1 && (this._filteredRows = this._filteredRows.slice(0, 1)),
                            this;
                        let h = "";
                        ...
                        if (this._filterInitialized) {
                            ...
                            return this._filteredRows = _,
                            this._filterInitialized = !0,
                            this
                        }
                        if (this._filteredRows = _,
                        this._filterInitialized = !0,
                        "$fts" === r) {
                            this._scoring = this._collection._fullTextSearch.search(n.$fts);
                            let e = Object.keys(this._scoring);
                        ...
                        if (void 0 !== this._collection._constraints.unique[r] && "$eq" === h) {
                            const e = this._collection._constraints.unique[r].get(l);
                            return void 0 !== e && _.push(this._collection.get(e, !0)[1]),
                            this
                        }
                        if (!c) {
                            for (let i = 0; i < data.length; i++)
                                if (d[h](data[i][r], l) && (_.push(i),
                                t))
                                    return this;
                            return this
                        }
                        if (this._collection._rangedIndexes[r]) {
                            if ("$in" === h) {
                                ...
                                for (let t of l) {
                                    ...
                                    for (let e of n)
                                        _.push(this._collection.get(e, !0)[1])
                                }
                                return this
                            }
                            if ("$between" === h) {
                                ...
                                for (let t of e)
                                    _.push(this._collection.get(t, !0)[1]);
                                return this
                            }
                            let e = this._collection._rangedIndexes[r].index.rangeRequest({
                                op: h,
                    ...
                    where(e) {
                        ...
                        this._filterInitialized) {
                            ...
                            for (; e--; )
                                !0 === t(this._collection._data[this._filteredRows[e]]) && n.push(this._filteredRows[e]);
                            return this._filteredRows = n,
                            this
                        }
                        {
                    ...
                    data(e={}) {
                        let t, n, r;
                        ({forceClones: t=!1, forceCloneMethod: n=this._collection._cloneMethod, removeMeta: r=!1} = e);
                        let o, l, h = [], data = this._collection._data;
                        if (r && !t && (t = !0,
                        n = "shallow"),
                        this._collection._disableDeltaChangesApi || (t = !0,
                        n = "deep"),
                        !this._filterInitialized) {
                            if (0 === this._filteredRows.length) {
                                if (this._collection._cloneObjects || t) {
                                    l = n;
                                    for (let i = 0; i < data.length; i++)
                                        o = this._collection._defineNestedProperties(d(data[i], l)),
                                        r && (delete o.$loki,
                                        delete o.meta),
                                        h.push(o);
                                    return h
                        ...
                        if (this._collection._cloneObjects || t) {
                            ...
                            for (let i = 0; i < c.length; i++)
                                o = this._collection._defineNestedProperties(d(data[c[i]], l)),
                                r && (delete o.$loki,
                                delete o.meta),
                                h.push(o)
                        } else
                    ...
                    eqJoin(e, t, n, r, o) {
                        let l, h, c = [], d = [], f = "function" == typeof t, _ = "function" == typeof n, w = {}, m = this.data(o), y = m.length;
                        if (e instanceof C)
                            c = e.chain().data(o);
                        ...
                        for (let e = 0; e < y; e++)
                            h = f ? t(m[e]) : m[e][t],
                            d.push(r(m[e], w[h] || {}));
                        return this._collection = new C("joinData"),
                    ...
                    map(e, t) {
                        ...
                        return this._collection = new C("mappedData"),
                ...
                class y extends r.a {
                    constructor(e, t, n={}) {
                        ...
                        this._sortDirty = !1,
                        ({persistent: this._persistent=!1, sortPriority: this._sortPriority="passive", minRebuildInterval: this._minRebuildInterval=1} = n),
                        this._collection = e,
                        this.name = t,
                    ...
                    _rematerialize({removeWhereFilters: e=!1}) {
                        ...
                        (this._sortFunction || this._sortCriteria || this._sortCriteriaSimple || null !== this._sortByScoring) && (this._sortDirty = !0),
                        e) {
                            let e = this._filterPipeline.length;
                            for (; e--; )
                                "where" === this._filterPipeline[e].type && (e !== this._filterPipeline.length - 1 && (this._filterPipeline[e] = this._filterPipeline[this._filterPipeline.length - 1]),
                                this._filterPipeline.length--)
                        }
                        const t = this._filterPipeline;
                        this._filterPipeline = [];
                        for (let e = 0; e < t.length; e++)
                            this.applyFind(t[e].val);
                        return this.data(),
                    ...
                    static fromJSONObject(e, t) {
                        ...
                        n._resultSet._filterInitialized = t._resultSet._filterInitialized,
                        n._rematerialize({
                    ...
                    applySortByScoring(e=!1) {
                        return this._sortFunction = null,
                        this._sortCriteria = null,
                        this._sortCriteriaSimple = null,
                    ...
                    startTransaction() {
                        return this._cachedResultSet = this._resultSet.copy(),
                        this
                    }
                    commit() {
                        return this._cachedResultSet = null,
                        this
                    }
                    rollback() {
                        return this._resultSet = this._cachedResultSet,
                        this._persistent && (this._resultData = this._resultSet.data(),
                        this.emit("rebuild", this)),
                        this
                    }
                    _indexOfFilterWithId(e) {
                        if ("string" == typeof e || "number" == typeof e)
                            for (let t = 0, n = this._filterPipeline.length; t < n; t++)
                                if (e === this._filterPipeline[t].uid)
                                    return t;
                        return -1
                    }
                    _addFilter(filter) {
                    ...
                    reapplyFilters() {
                        this._resultSet.reset(),
                        this._cachedResultSet = null,
                        this._persistent && (this._resultData = [],
                        this._resultDirty = !0);
                        const e = this._filterPipeline;
                        this._filterPipeline = [];
                        for (let t = 0, n = e.length; t < n; t++)
                            this._addFilter(e[t]);
                        return this._sortFunction || this._sortCriteria || this._sortCriteriaSimple || null !== this._sortByScoring ? this._queueSortPhase() : this._queueRebuildEvent(),
                        this
                    }
                    applyFilter(filter) {
                        const e = this._indexOfFilterWithId(filter.uid);
                        return e >= 0 ? (this._filterPipeline[e] = filter,
                        this.reapplyFilters()) : (this._cachedResultSet = null,
                        this._persistent && (this._resultData = [],
                        this._resultDirty = !0),
                        this._addFilter(filter),
                        this._sortFunction || this._sortCriteria || this._sortCriteriaSimple || null !== this._sortByScoring ? this._queueSortPhase() : this._queueRebuildEvent(),
                        this)
                    }
                    applyFind(e, t="") {
                    ...
                    removeFilter(e) {
                        ...
                        return this._filterPipeline.splice(t, 1),
                        this.reapplyFilters(),
                        this
                    }
                    count() {
                        return this._resultDirty && (this._resultData = this._resultSet.data()),
                    ...
                    _queueRebuildEvent() {
                        this._rebuildPending || (this._rebuildPending = !0,
                        setTimeout(( () => {
                            this._rebuildPending && (this._rebuildPending = !1,
                            this.emit("rebuild", this))
                        }
                        ), this._minRebuildInterval))
                    }
                    _queueSortPhase() {
                        this._sortDirty || (this._sortDirty = !0,
                        "active" === this._sortPriority ? setTimeout(( () => {
                            this._performSortPhase()
                        }
                        ), this._minRebuildInterval) : this._queueRebuildEvent())
                    }
                    _performSortPhase(e={}) {
                        (this._sortDirty || this._resultDirty) && (this._sortDirty && (this._sortFunction ? this._resultSet.sort(this._sortFunction) : this._sortCriteria ? this._resultSet.compoundsort(this._sortCriteria) : this._sortCriteriaSimple ? this._resultSet.simplesort(this._sortCriteriaSimple.field, this._sortCriteriaSimple.options) : null !== this._sortByScoring && this._resultSet.sortByScoring(this._sortByScoring),
                        this._sortDirty = !1),
                        this._persistent && (this._resultData = this._resultSet.data(),
                        this._resultDirty = !1),
                    ...
                    _evaluateDocument(e, t) {
                        if (!this._resultSet._filterInitialized)
                            ...
                            void (this._sortFunction || this._sortCriteria || this._sortCriteriaSimple ? this._queueSortPhase() : this._queueRebuildEvent());
                        ...
                        return -1 !== r || -1 !== h ? -1 === r && -1 !== h ? (n.push(e),
                        this._persistent && this._resultData.push(this._collection._data[e]),
                        void (this._sortFunction || this._sortCriteria || this._sortCriteriaSimple ? this._queueSortPhase() : this._queueRebuildEvent())) : -1 !== r && -1 === h ? (r < o - 1 ? (n.splice(r, 1),
                        this._persistent && this._resultData.splice(r, 1)) : (n.length = o - 1,
                        this._persistent && (this._resultData.length = o - 1)),
                        void (this._sortFunction || this._sortCriteria || this._sortCriteriaSimple ? this._queueSortPhase() : this._queueRebuildEvent())) : void (-1 !== r && -1 !== h && (this._persistent && (this._resultData[r] = this._collection._data[e]),
                    ...
                    _removeDocument(e) {
                        ...
                        -1 !== n && (n < r - 1 ? (t[n] = t[r - 1],
                        t.length = r - 1,
                        this._persistent && (this._resultData[n] = this._resultData[r - 1],
                        this._resultData.length = r - 1)) : (t.length = r - 1,
                ...
                class C extends r.a {
                    constructor(e, t={}) {
                        ...
                        if (this.name = e,
                        this._unindexedSortComparator = t.unindexedSortComparator || "js",
                        this._defaultLokiOperatorPackage = t.defaultLokiOperatorPackage || "js",
                        void 0 !== t.unique && (Array.isArray(t.unique) || (t.unique = [t.unique]),
                        t.unique.forEach((e => {
                            this._constraints.unique[e] = new o(e)
                        }
                        ))),
                        void 0 !== S.a.FullTextSearch ? this._fullTextSearch = void 0 !== t.fullTextSearch ? new S.a.FullTextSearch(t.fullTextSearch) : null : this._fullTextSearch = null,
                        ...
                        this._cloneMethod = void 0 !== t.cloneMethod ? t.cloneMethod : "deep",
                        this._disableChangesApi && (this._disableDeltaChangesApi = !0),
                        this._serializableIndexes = void 0 === t.serializableIndexes || t.serializableIndexes,
                        ...
                        for (let e in n)
                            this.ensureRangedIndex(e, n[e].indexTypeName, n[e].comparatorName);
                    ...
                    static fromJSONObject(e, t) {
                        ...
                        if (n._transactional = e.transactional,
                        ...
                        for (let t in e.rangedIndexes) {
                            let r = e.rangedIndexes[t]
                              , o = (0,
                            x.a[r.indexTypeName])(t, _.a[r.comparatorName]);
                            o.restore(r.index),
                            n._rangedIndexes[t].index = o
                        }
                        if (n._ensureId(),
                        void 0 !== e.uniqueNames)
                        ...
                        if (void 0 !== e._dynamicViews)
                            for (let t = 0; t < e._dynamicViews.length; t++)
                                n._dynamicViews.push(y.fromJSONObject(n, e._dynamicViews[t]));
                        return e._fullTextSearch && (n._fullTextSearch = S.a.FullTextSearch.fromJSONObject(e._fullTextSearch, t.fullTextSearch)),
                        n
                    }
                    addTransform(e, t) {
                    ...
                    setTTL(e, t) {
                        e < 0 ? clearInterval(this._ttl.daemon) : (this._ttl.age = e,
                    ...
                    addDynamicView(e, t) {
                        ...
                        return this._dynamicViews.push(n),
                        n
                    }
                    removeDynamicView(e) {
                        for (let t = 0; t < this._dynamicViews.length; t++)
                            this._dynamicViews[t].name === e && this._dynamicViews.splice(t, 1)
                    }
                    getDynamicView(e) {
                        for (let t = 0; t < this._dynamicViews.length; t++)
                    ...
                    insert(e) {
                        ...
                        for (let i = 0; i < e.length; i++) {
                            if (t = this.insertOne(e[i], !0),
                            !t)
                                return;
                            n.push(t)
                        }
                        return this.emit("insert", n),
                        n = this._cloneObjects ? d(n, this._cloneMethod) : n,
                        1 === n.length ? n[0] : n
                    }
                    insertOne(e, t=!1) {
                        let n, r = null;
                        if ("object" != typeof e ? r = new TypeError("Document needs to be an object") : null === e && (r = new TypeError("Object cannot be null")),
                        null !== r)
                        ...
                        this._add(o))
                            return this._disableChangesApi ? this._insertMeta(o) : this._insertMetaWithChange(o),
                    ...
                    clear({removeIndices: e=!1}={}) {
                        ...
                        !0 === e)
                            ...
                            for (let e in this._rangedIndexes)
                                this.ensureRangedIndex(e, this._rangedIndexes[e].indexTypeName, this._rangedIndexes[e].comparatorName);
                    ...
                    update(e) {
                        if (Array.isArray(e))
                            ...
                            try {
                                ...
                                null !== this._fullTextSearch && this._fullTextSearch.updateDocument(e, r),
                                this.commit(),
                                this._dirty = !0,
                                this._disableChangesApi ? this._updateMeta(o) : this._updateMetaWithChange(o, n);
                                let l = o;
                    ...
                    _add(e) {
                        ...
                        try {
                            this.startTransaction(),
                            this._maxId++,
                            isNaN(this._maxId) && (this._maxId = this._data[this._data.length - 1].$loki + 1);
                            const t = e;
                            t.$loki = this._maxId,
                            ...
                            for (let n in this._rangedIndexes)
                                this._serializableIndexes && t[n]instanceof Date && (t[n] = t[n].getTime()),
                                this._rangedIndexes[n].index.insert(e.$loki, e[n]);
                            return null !== this._fullTextSearch && this._fullTextSearch.addDocument(t, r),
                            this.commit(),
                            this._dirty = !0,
                    ...
                    remove(e) {
                        if ("number" == typeof e && (e = this.get(e)),
                        Array.isArray(e)) {
                            let t = 0;
                            const n = e.length;
                            for (; t < n; t++)
                            ...
                            try {
                                ...
                                null !== this._fullTextSearch && this._fullTextSearch.removeDocument(e, n),
                                this.commit(),
                                this._dirty = !0,
                                this._disableChangesApi || this._createChange(this.name, "R", t[0]),
                    ...
                    _insertMetaWithChange(e) {
                        this._insertMeta(e),
                        this._createInsertChange(e)
                    }
                    _updateMetaWithChange(e, t) {
                        this._updateMeta(e),
                        this._createUpdateChange(e, t)
                    }
                    _insertMeta(e) {
                    ...
                    _updateMeta(e) {
                        this._disableMeta || (e.meta.updated = (new Date).getTime(),
                        e.meta.revision += 1)
                    }
                    get(e, t=!1) {
                        if (!t) {
                        ...
                        let n = data.length - 1
                          , r = 0
                          , o = r + n >> 1;
                        if (e = "number" == typeof e ? e : parseInt(e, 10),
                        isNaN(e))
                    ...
                    startTransaction() {
                        if (this._transactional) {
                            let e = {};
                            for (let t in this._rangedIndexes)
                                e[t].indexTypeName = this._rangedIndexes[t].indexTypeName,
                                e[t].comparatorName = this._rangedIndexes[t].comparatorName,
                        ...
                        if (this._transactional && null !== this._cached) {
                            ...
                            for (let e in this._cached.rangedIndexes) {
                                let t = this._cached.rangedIndexes[e]
                                  , n = (0,
                                x.a[t.indexTypeName])(e, _.a[t.comparatorName]);
                                n.restore(t.index),
                                this._rangedIndexes[e].index = n
                            }
                            for (let e = 0; e < this._dynamicViews.length; e++)
                    ...
                    getStage(e) {
                        return this._stages[e] || (this._stages[e] = {}),
                        this._stages[e]
                    }
                    stage(e, t) {
                        const n = JSON.parse(JSON.stringify(t));
                        return this.getStage(e)[t.$loki] = n,
                        n
                    }
                    commitStage(e, t) {
            ...
            , function(e, t, n) {
                ...
                class r {
                    ...
                    backup() {
                        ...
                        return e.nodes = JSON.parse(JSON.stringify(this.nodes)),
                        e.apex = this.apex,
                        e
                    }
                    restore(e) {
                    ...
                    insertNode(e, t) {
                        ...
                        case 0:
                            e.siblings.push(t.id),
                            t.parent = e.id;
                            break;
                        case 1:
                            e.right ? (this.insertNode(this.nodes[e.right], t),
                            this.updateBalance(e)) : (e.right = t.id,
                            t.parent = e.id,
                            this.updateBalance(e));
                            break;
                        case -1:
                            e.left ? (this.insertNode(this.nodes[e.left], t),
                            this.updateBalance(e)) : (e.left = t.id,
                            t.parent = e.id,
                            this.updateBalance(e));
                            break;
                        default:
                    ...
                    leftRightCase(e) {
                        ...
                        return e.left = this.rotateLeft(this.nodes[e.left]).id,
                        this.rotateRight(e)
                    }
                    rightRightCase(e) {
                    ...
                    rightLeftCase(e) {
                        ...
                        return e.right = this.rotateRight(this.nodes[e.right]).id,
                        this.rotateLeft(e)
                    }
                    rotateLeft(e) {
                        if (!e.right)
                    ...
                    update(e, t) {
                        let n = this.nodes[e];
                        0 !== this.comparator(n.value, t) && (this.remove(e),
                        this.insert(e, t))
                    }
                    remove(e) {
                        if (!this.apex)
                        ...
                        case 0:
                            if (e.siblings.length > 0) {
                                if (e.id === t) {
                                    ...
                                    for (let e of r.siblings)
                                        this.nodes[e].parent = n;
                                ...
                                }
                                {
                                    ...
                                    return e.siblings.splice(n, 1),
                                    void delete this.nodes[t]
                                }
                            }
                            return e.left || e.right ? e.left && e.right ? void this.promoteSuccessor(e) : (e.left && (this.promoteChild(e, this.nodes[e.left]),
                            this.apex === t && (this.apex = e.left)),
                            void (e.right && (this.promoteChild(e, this.nodes[e.right]),
                            this.apex === t && (this.apex = e.right)))) : (this.updateChildLink(e.parent, e.id, null),
                            delete this.nodes[t],
                    ...
                    collateIds(e) {
                        let t = [];
                        return e ? (e.left && (t = this.collateIds(this.nodes[e.left])),
                        t.push(e.id),
                        t.push(...e.siblings),
                        e.right && t.push(...this.collateIds(this.nodes[e.right])),
                        t) : []
                    }
                    locate(e, t) {
                        for (; null !== e; )
                    ...
                    validateIndex() {
                        if (!this.apex)
                            return 0 === Object.keys(this.nodes).length;
                        if (null !== this.nodes[this.apex].parent)
                            return !1;
                        ...
                        if (e.length !== t)
                            return !1;
                        if (1 === e.length)
                            return null === this.nodes[e[0]].parent && null === this.nodes[e[0]].left && null === this.nodes[e[0]].right;
                        for (let i = 0; i < e.length - 1; i++)
                            if (1 === this.comparator(this.nodes[e[i]].value, this.nodes[e[i + 1]].value))
                                return !1;
                    ...
                    validateNode(e) {
                        ...
                        if (e.siblings.length > 0)
                            for (let t of e.siblings)
                                if (this.nodes[t].parent !== e.id)
                                    return !1;
                        if (e.left) {
                            if (this.nodes[e.left].parent !== e.id)
                                return !1;
                            if (!this.validateNode(this.nodes[e.left]))
                                return !1
                        }
                        if (e.right) {
                            if (this.nodes[e.right].parent !== e.id)
                                return !1;
                            if (!this.validateNode(this.nodes[e.right]))
                                return !1
                        }
                        return !0
                    }
                ...
                (function(e) {
                    ...
                    function f() {
                        if (void 0 !== e && (e.android || e.NSObject))
                            return "NATIVESCRIPT";
                        if (void 0 !== e && "[object process]" === {}.toString.call(e.process))
                            return e.window,
                            "NODEJS";
                        if (void 0 !== document)
                            return -1 === document.URL.indexOf("http://") && -1 === document.URL.indexOf("https://") ? "CORDOVA" : "BROWSER";
                        if (void 0 !== window && "[object Window]" === {}.toString.call(window))
                            return "BROWSER";
                    ...
                    class _ extends r.a {
                        constructor(e="loki.db", t={}) {
                            ...
                            this.filename = e,
                            this._collections = [],
                            ({serializationMethod: this._serializationMethod="normal", destructureDelimiter: this._destructureDelimiter="$<\n", env: this._env=f()} = t),
                            this._events = {
                                init: [],
                                loaded: [],
                                flushChanges: [],
                            ...
                            t.comparatorMap)
                                for (let e in t.comparatorMap)
                                    h.a[e] = t.comparatorMap[e];
                        ...
                        initializePersistence(e={}) {
                            ...
                            ({autosave: this._autosave=!1, autosaveInterval: this._autosaveInterval=5e3, persistenceMethod: this._persistenceMethod, throttledSaves: this._throttledSaves=!0} = e);
                            const n = {
                                NODEJS: ["fs-storage"],
                            ...
                            if (void 0 !== e.adapter && (this._persistenceMethod = "adapter",
                            ...
                            return e.autoload && (t = t.then(( () => this._loadDatabase(e.inflate, !0)))),
                            t.then(( () => {
                        ...
                        addCollection(e, t={}) {
                            ...
                            const n = new o.a(e,t);
                            return this._collections.push(n),
                            n
                        }
                        loadCollection(e) {
                            if (!e.name)
                        ...
                        getCollection(e) {
                            for (let i = 0; i < this._collections.length; i++)
                                if (this._collections[i].name === e)
                                    return this._collections[i];
                            return this.emit("warning", "collection " + e + " not found"),
                            null
                        }
                        ...
                        serializeDestructured(e={}) {
                            if (void 0 === e.partitioned && (e.partitioned = !1),
                            void 0 === e.delimited && (e.delimited = !0),
                            void 0 === e.delimiter && (e.delimiter = this._destructureDelimiter),
                            !0 === e.partitioned && void 0 !== e.partition && e.partition >= 0)
                            ...
                            return e.partitioned ? (e.delimited,
                            n) : e.delimited ? (n.push(""),
                            n.join(e.delimiter)) : (n.push(""),
                            n)
                        }
                        serializeCollection(e={}) {
                            if (void 0 === e.delimited && (e.delimited = !0),
                            void 0 === e.collectionIndex)
                                throw new Error("serializeCollection called without 'collectionIndex' option");
                            const t = this._collections[e.collectionIndex].count();
                            let n = [];
                            for (let r = 0; r < t; r++)
                                n.push(JSON.stringify(this._collections[e.collectionIndex]._data[r]));
                            return e.delimited ? (n.push(""),
                            n.join(e.delimiter)) : n
                        }
                        deserializeDestructured(e, t={}) {
                            if (void 0 === t.partitioned && (t.partitioned = !1),
                            void 0 === t.delimited && (t.delimited = !0),
                            void 0 === t.delimiter && (t.delimiter = this._destructureDelimiter),
                            t.partitioned) {
                                ...
                                for (let o = 0; o < r; o++)
                                    n._collections[o]._data = this.deserializeCollection(e[o + 1], t);
                                return n
                            }
                            let n = [];
                            if (t.delimited) {
                                if (n = e.split(t.delimiter),
                                e = null,
                                0 === n.length)
                                    return null
                            } else
                            ...
                            let l = 0
                              ...
                              , c = !1;
                            for (; !c; )
                                "" === n[h] ? ++l > o && (c = !0) : r._collections[l]._data.push(JSON.parse(n[h])),
                                n[h++] = null;
                            return r
                        }
                        ...
                        loadJSONObject(e, t={}) {
                            ...
                            this._collections = [];
                            for (let i = 0; i < n; ++i)
                                this._collections.push(o.a.fromJSONObject(e._collections[i], t))
                        }
                        close() {
                        ...
                        throttledSaveDrain(e={}) {
                            ...
                            return this._throttledSaves ? (void 0 === e.recursiveWait && (e.recursiveWait = !0),
                            void 0 === e.recursiveWaitLimit && (e.recursiveWaitLimit = !1),
                            void 0 === e.recursiveWaitLimitDuration && (e.recursiveWaitLimitDuration = 2e3),
                            void 0 === e.started && (e.started = new Date),
                            this._throttledSaves && null !== this._throttledSaveRunning ? e.recursiveWait ? Promise.resolve(Promise.all([this._throttledSaveRunning, this._throttledSavePending])).then(( () => null !== this._throttledSaveRunning || null !== this._throttledSavePending ? e.recursiveWaitLimit && t - e.started.getTime() > e.recursiveWaitLimitDuration ? Promise.reject({}) : this.throttledSaveDrain(e) : Promise.resolve())) : Promise.resolve(this._throttledSaveRunning) : Promise.resolve()) : Promise.resolve()
                        }
                        _loadDatabase(e={}, t=!1) {
                            return null === this._persistenceAdapter ? Promise.reject(new Error("persistenceAdapter not configured")) : Promise.resolve(this._persistenceAdapter.loadDatabase(this.filename)).then((t => {
                                if ("string" == typeof t)
                                    ...
                                    if ("object" != typeof t || null === t || t instanceof Error)
                                        throw t;
                                    this.loadJSONObject(t, e),
                                    this.emit("load", this)
                                }
                            }
                            )).catch((e => {
                        ...
                        _saveDatabase() {
                            ...
                            Promise.resolve(this._persistenceAdapter.saveDatabase(this.filename, this.serialize())).then(( () => {
                                this.emit("save")
                            }
                            )))
                        }
                        saveDatabase() {
                            return this._throttledSaves ? (null !== this._throttledSaveRunning && null === this._throttledSavePending && (this._throttledSavePending = Promise.resolve(this._throttledSaveRunning).then(( () => (this._throttledSaveRunning = null,
                            this._throttledSavePending = null,
                            this.saveDatabase())))),
                            null !== this._throttledSavePending ? this._throttledSavePending : (this._throttledSaveRunning = this._saveDatabase().then(( () => {
                                this._throttledSaveRunning = null
                            }
                            )),
                        ...
                        _autosaveDisable() {
                            return this._autosaveRunning = !1,
            ...
            , function(e, t, n) {
                ...
                class f {
                    constructor(e={}) {
                        ...
                        this.root = new Map,
                        ({store: this._store=!0, optimizeChanges: this._optimizeChanges=!0, analyzer: this.analyzer=new c} = e)
                    }
                    insert(e, t) {
                        if (this.docStore.has(t))
                    ...
                    remove(e) {
                        if (!this.docStore.has(e))
                            return;
                        const t = this.docStore.get(e);
                        if (this.docStore.delete(e),
                        0 !== t.fieldLength)
                            if (this.docCount -= 1,
                    ...
                    static fromJSONObject(e, t) {
                        ...
                        return e._store && (n.docCount = e.docCount,
                    ...
                    _remove(e, t) {
                        for (const n of e)
                            this._remove(n[1], t) && e.delete(n[0]);
                        return void 0 !== e.df && e.dc.has(t) && (e.df -= 1,
                        e.dc.delete(t),
                        0 === e.df && (delete e.df,
                        delete e.dc)),
                    ...
                    constructor(e) {
                        ...
                        for (let n = 0; n < t; n++) {
                            ...
                            for (let t = 0; t < this._points.length; t++)
                                this._transitions[n * this._points.length + t] = e.step(n, this._points[t])
                        }
                        this._classmap = new Array(256);
                        for (let i = 0, e = 0; e < this._classmap.length; e++)
                            i + 1 < this._points.length && e === this._points[i + 1] && i++,
                            this._classmap[e] = i
                    }
                    getCharClass(e) {
                        let a = 0
                ...
                class x {
                    ...
                    _finishCurrentState() {
                        ...
                        for (let i = 0, t = this._stateTransitions.length; i < t; i++) {
                            ...
                            p[0] === t[0] ? t[1] <= p[2] + 1 ? t[2] > p[2] && (p[2] = t[2]) : (-1 !== p[0] && (this._stateTransitions[e][0] = p[0],
                            this._stateTransitions[e][1] = p[1],
                            this._stateTransitions[e][2] = p[2],
                            e++),
                            p[1] = t[1],
                            p[2] = t[2]) : (-1 !== p[0] && (this._stateTransitions[e][0] = p[0],
                            this._stateTransitions[e][1] = p[1],
                            this._stateTransitions[e][2] = p[2],
                            e++),
                            p[0] = t[0],
                        ...
                        -1 !== p[0] && (this._stateTransitions[e][0] = p[0],
                        this._stateTransitions[e][1] = p[1],
                        this._stateTransitions[e][2] = p[2],
                        e++),
                        this._transitions[this._currState] = this._stateTransitions.slice(0, e).sort(y),
                        this._stateTransitions = []
                    }
                    getStartPoints() {
                        const e = new Set;
                    ...
                    addTransition(source, e, t, n) {
                        this._currState !== source && (-1 !== this._currState && this._finishCurrentState(),
                ...
                class I {
                    ...
                    static unpack(data, e, t) {
                        const n = t * e
                          ...
                          , o = 63 & n;
                        if (o + t <= 64)
                            return data[r].shiftRight(o).and(k[t - 1]).toInt();
                        {
                            const e = 64 - o;
                ...
                const C = [new S(2)]
                  ...
                  , P = [new S(2416705539,559024212), new S(1161073005,1531779490), new S(55860)]
                ...
                class H {
                    constructor(input, e) {
                        ...
                        for (let i = 0; i < this._alphabet.length; i++) {
                            ...
                            e > t && (this._rangeLower[this._numRanges] = t,
                            this._rangeUpper[this._numRanges] = e - 1,
                            this._numRanges++),
                            t = e + 1
                        }
                        t <= m && (this._rangeLower[this._numRanges] = t,
                        this._rangeUpper[this._numRanges] = m,
                        this._numRanges++),
                        this._description = 1 === e ? new j(input.length) : new Q(input.length)
                    }
                    toAutomaton() {
                        let e = new x;
                        ...
                        for (let r = 0; r < n; r++) {
                            ...
                            if (l >= 0)
                                for (let t = 0; t < this._numRanges; t++)
                                    e.addTransition(r, l, this._rangeLower[t], this._rangeUpper[t])
                        }
                ...
                class Y {
                    ...
                    _recursive(e, t) {
                        ...
                        let l = null
                          , c = null;
                        switch (void 0 !== this._invIdxs[o] && (l = this._invIdxs[o].root,
                        c = this._invIdxs[o].analyzer),
                        e.type) {
                        case "bool":
                            if (n = null,
                            void 0 !== e.must && (n = this._getUnique(e.must, t, n)),
                            void 0 !== e.filter && (n = this._getUnique(e.filter, null, n)),
                            void 0 !== e.should) {
                                ...
                                if (o && 1 === l)
                                    ...
                                    for (const [e,t] of r)
                                        t.length >= l && (n.has(e) ? n.get(e).push(...t) : o ? n.set(e, t) : n.delete(e))
                            }
                        ...
                        case "fuzzy":
                            {
                                const [h,c] = function(e, t) {
                                    ...
                                    function S(e, t, n) {
                                        let o = 0;
                                        if (-1 !== (e = x.step(e, 0)) && x.isAccept(e) && (o++,
                                            ...
                                            if (o !== r)
                                                return function(a, b) {
                                                    ...
                                                    for (i = 1; i <= b.length; i++) {
                                                        for (t = i,
                                                        e = 1; e <= a.length; e++)
                                                            b[i - 1] === a[e - 1] ? n = r[e - 1] : (n = Math.min(r[e - 1] + 1, Math.min(t + 1, r[e] + 1)),
                                                            i > 1 && e > 1 && b[i - 2] === a[e - 1] && a[e - 2] === b[i - 1] && (n = Math.min(n, r[e - 1] - (a[e - 1] === b[i - 1] ? 1 : 0)))),
                                                            r[e - 1] = t,
                                                            t = n;
                                                        r[a.length] = t
                                                    }
                                ...
                                for (let i = 0; i < h.length; i++)
                                    this._scorer.score(o, r * h[i].boost, h[i].index, t, n, h[i].term, c);
                                break
                            }
                        case "wildcard":
                            {
                                        ...
                                        if (null !== e)
                                            if (t !== n.length)
                                                if (h || 92 !== n[t])
                                                    if (h || 63 !== n[t])
                                                        if (h || 42 !== n[t])
                                                            o(f.getTermIndex([n[t]], e), t + 1, [...l, n[t]]);
                                                        else if (t + 1 === n.length) {
                                                            const n = f.extendTermIndex(e);
                                                            for (let i = 0; i < n.length; i++)
                                                                o(n[i].index, t + 1, [...l, ...n[i].term])
                                                        } else {
                                                            o(e, t + 1, l, !1);
                                                            const n = [{
                                                                index: e,
                                ...
                                for (let i = 0; i < c.length; i++)
                                    this._scorer.score(o, r, c[i].index, t && h, n, c[i].term);
                                break
                            }
                        case "match_all":
                        ...
                        case "prefix":
                            {
                                ...
                                if (null !== _) {
                                    ...
                                    for (let i = 0; i < e.length; i++)
                                        this._scorer.score(o, r, e[i].index, t && h, n, [...c, ...e[i].term])
                                }
                                break
                            }
                        case "exists":
                        ...
                        case "match":
                            {
                                const l = h(c, e.value)
                                  ...
                                  , f = [];
                                if ("or" === (void 0 !== e.operator ? e.operator : "or") ? (void 0 !== e.minimum_should_match && (d.minimum_should_match = e.minimum_should_match),
                                d.should = f) : d.must = f,
                                d.boost = r,
                                void 0 !== e.fuzziness) {
                ...
                class Z {
                    ...
                    updateDocument(e, t=e[this._id]) {
                        ...
                        this.addDocument(e, t)
                    }
                    clear() {
                        for (let e of this._docs)
                            this.removeDocument(null, e)
                    }
                    search(e) {
    ...
    379: function(e, t, n) {
        ...
        t.default = function(e) {
            return (f = new c.a("content.db")).loadJSONObject(e),
